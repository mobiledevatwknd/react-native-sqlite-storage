    ...
    render(){
        ...
        return (<View style={styles.mainContainer}>
            <View style={styles.toolbar}>
				<TouchableOpacity  onPress={this.runDemo} style={styles.toolbarTouchable}>
               	  <Text style={styles.toolbarButton}>
	             	Run Demo
	              </Text>
				</TouchableOpacity>
				<TouchableOpacity onPress={this.closeDatabase} style={styles.toolbarTouchable}>
                  <Text style={styles.toolbarButton} >
                    Close DB
                  </Text>
				</TouchableOpacity>
				<TouchableOpacity onPress={this.deleteDatabase} style={styles.toolbarTouchable}>
                  <Text style={styles.toolbarButton} >
                    Delete DB
                  </Text>
				</TouchableOpacity>
